...
public class ProcessedPullMessagesResponse {
    ...
    public ProcessedPullMessagesResponse(PullMessagesResponse response) {
        ...
        response.getNotificationMessage().forEach((nm) -> {
            ...
            if (any instanceof Element messageElement) {

                // Get PropertyOperation from <Message>
                String operation = messageElement.getAttribute("PropertyOperation");


                var dataLst = messageElement.getElementsByTagNameNS(tt, "Data");
                ...
                var sourceLst = messageElement.getElementsByTagNameNS(tt, "Source");
                ...
                responseData.add(new PullMessagesResponseData(nm.getTopic().getContent().getFirst().toString(), source, data,operation));
            }
        });
    }
}
